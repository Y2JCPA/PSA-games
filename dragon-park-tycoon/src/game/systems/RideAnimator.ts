...
export class RideAnimator {
  ...
  addRide(scene: Phaser.Scene, buildingId: string, def: BuildingDef, px: number, py: number, pw: number, ph: number, level: number = 1) {
    ...
    const sprite = scene.add.image(cx, cy, textureKey || 'coin');
  ...
  private makeDragonUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, w: number, h: number, sparkles: Phaser.GameObjects.Arc[]) {
  ...
  private makeCarouselUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, sparkles: Phaser.GameObjects.Arc[]) {
    return (time: number) => {
  ...
  private makeSerpentUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, w: number, sparkles: Phaser.GameObjects.Arc[]) {
    return (time: number) => {
  ...
  private makeUnicornUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, w: number, sparkles: Phaser.GameObjects.Arc[]) {
  ...
  private makePhoenixUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, h: number, sparkles: Phaser.GameObjects.Arc[]) {
  ...
  private makeWhirlwindUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, sparkles: Phaser.GameObjects.Arc[]) {
    return (time: number) => {
  ...
  private makeBumperUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, sparkles: Phaser.GameObjects.Arc[]) {
    return (time: number) => {
  ...
  private makeSwingUpdate(sprite: Phaser.GameObjects.Image, cx: number, cy: number, sparkles: Phaser.GameObjects.Arc[]) {
    return (time: number) => {
